...
export default function BoutonImprimer() {
  return (
    <button
      ...
      className="sans-impression inline-flex items-center justify-center gap-2 min-h-[44px] px-4 rounded-mf-sm text-sm font-semibold bg-mf-blue hover:bg-mf-blue-hover text-mf-on-blue transition-colors"
    >
