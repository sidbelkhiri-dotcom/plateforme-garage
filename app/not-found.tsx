  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-mf-bg p-6">
      <div className="text-center max-w-sm">
        ...
        <div className="font-display font-bold text-5xl text-mf-text mb-2">404</div>
        ...
        <Link
          href="/"
          className="inline-flex items-center justify-center min-h-[44px] px-4 rounded-mf-sm text-sm font-semibold bg-mf-blue hover:bg-mf-blue-hover text-mf-on-blue transition-colors"
        >
