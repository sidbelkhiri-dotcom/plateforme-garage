      ...
      <div className="sticky bottom-0 z-10 -mx-6 mt-2 px-6 py-3 bg-mf-bg border-t border-mf-border flex flex-wrap gap-2 empty:hidden [&>*]:flex-1 [&>*]:basis-full sm:[&>*]:flex-none sm:[&>*]:basis-auto">
        ...
        {bon.statut === "facture" && factureId && (
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 min-h-[44px] px-4 rounded-mf-sm text-sm font-semibold bg-mf-blue hover:bg-mf-blue-hover text-mf-on-blue transition-colors"
          >
